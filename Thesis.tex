...
% blindreview for blind reivew otherwise just remove it
...
%->> Document settings
%---------------------------------------------------------------------------%
% Define a boolean for blind review (default: false)
\newif\ifblindreview
\blindreviewfalse % Default: false (set to \blindreviewtrue to enable)

\usepackage[bibtex,myhdr,table,list,geometry]{Style/artratex}
% document settings
%- usage: \usepackage[option1,option2,...,optionN]{artratex}
% for blind review add => blindreview in a [] by adding a comma before the
% given values
%- Multiple optional arguments:
...
\CTEXsetup[name={Chapter\,,}]{chapter}
%---------------------------------------------------------------------------%
%->> Document inclusion
%---------------------------------------------------------------------------%
